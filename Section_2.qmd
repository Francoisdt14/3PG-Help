...
Depending on where your simulations occur, these layers may be freely available. If not, some researchers use default values, while others derive these variables from auxiliary data such as a DEM for available soil water, or soil carbon estimates for soil fertility. \[**CO2 factor to come!**\].
...
Additional species parameterizations can be found **WHERE**
