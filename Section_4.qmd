...
The parameter "output directory" gives a path to a directory in which output raster files will be written. The output variables are selected and named as demonstrated in the example site file in [Additional Resources and Examples](/Section_7.qmd). In standard mode

**Check this** ... 9 variables are available for output, and are listed in the example file example2.txt. In satellite mode only 4 variables are available for output, and are listed in the example file example3.txt. -\> **satellite mode has not been disabled, just need to be clear in the instructions on usage**
...
**Check this how much of this has changed - currently satellite mode enabled**
