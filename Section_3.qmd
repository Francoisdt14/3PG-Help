...
::: callout-important
The parameter "Model mode" is required and should appear at the top of the site paramter file. The parameter "output directory" is also required and gives the path to a directory in which output rasters will be written. For example:
