...
The 3-PG executable can be run on Windows (**still need to test Mac and/or Linux**). The main limitation of 3-PG is the size of the input files - minimum system requirements can be highlighted here, or we can send readers to [Technical Details](./Section_8.qmd).
