...
The 3-PG executable can be run on Windows (Mac? Linux?).

### <i class="fa-solid fa-gears"></i> Installation process

To use the executable, copy and paste it to your desired location. After that, all you need is the file path.

### <i class="fa-solid fa-chalkboard-user"></i> Usage
...
::: callout-important
The parameters "Model mode" and "Output directory" are required, and should appear at the top of the site parameter file. "Output directory" gives the path to a directory in which output rasters will be written. For example:
...
::: callout-tip
Example parameter files are provided in [Section 7](./Section_7.qmd)
:::
